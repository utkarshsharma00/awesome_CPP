...
{ 
    //passing of this ampersand in vector is very important otherwise it will lead to Deep Copy of the contents of the vector which is very costly in terms of memeory
